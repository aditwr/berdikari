...
@endif ">
                        ...
                        <span
                            class="@if (Route::is('dashboard.ringkasan')) font-medium text-primary-50 @endif">Ringkasan</span>
                    </a>
                </li>
                <li class="relative pt-4">
                    <span
                        class="py-4 px-6 text-[0.6rem] font-bold uppercase text-gray-600 dark:text-gray-400">Create</span>
