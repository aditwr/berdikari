...
<div class="container mx-auto my-24 padding-responsive-in-container">

    <!-- Section: Design Block -->
    <section class="mb-32 text-gray-800">

        <h2 class="mb-12 text-3xl font-bold text-center">Tulisan Kami</h2>
                        ...
                        <div class="absolute top-0 bottom-0 left-0 right-0 w-full h-full overflow-hidden bg-fixed"
                            ...
                            <div class="flex items-end justify-start h-full">
                                <div class="m-6 text-white">
                                    <h5 class="mb-3 text-lg font-bold">{{ $artikel->judul }}</h5>
                                    <p>
                                        <small>Published <u>{{ $artikel->created_at->format('l, d M Y') }}</u> by
                                            {{ $artikel->penulis }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
