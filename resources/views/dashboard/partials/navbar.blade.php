...
<nav class="fixed top-0 right-0 h-16 sm:h-16 left-0 z-50 flex w-full flex-nowrap items-center justify-between bg-white py-[0.6rem] text-gray-500 shadow-lg hover:text-gray-700 focus:text-gray-700 dark:bg-zinc-700 lg:flex-wrap lg:justify-start xl:pl-60"
    data-te-navbar-ref>
    <!-- Container wrapper -->
    <div class="flex flex-wrap items-center justify-between w-full px-4 gap-y-4 xl:justify-end">
        <!-- Toggler -->
        <button data-te-sidenav-toggle-ref data-te-target="#sidenav-1" type="button"
        ...
        <!-- Search form -->
        <form class="relative flex flex-wrap items-stretch hidden ml-4 mr-auto xl:mx-0">
