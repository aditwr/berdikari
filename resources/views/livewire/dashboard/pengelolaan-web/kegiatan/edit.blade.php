<div>
    ...
    <div class="w-full 2xl:w-9/12">
        ...
        <form action="" wire:submit.prevent='update' method="POST" class="block w-full">
            @csrf
            <div class="mb-4">
                <label for="judul-catatan" class="block mb-2 font-medium caption text-dark-secondary">Judul
                    Kegiatan</label>
                <input type="text" name="judulKegiatan" wire:model="judulKegiatan" id="judul-catatan"
            ...
            <div class="mb-4">
                ...
                {{-- image preview --}}
                @if ($foto)
                    <img src="{{ $foto->temporaryUrl() }}" alt="" class="h-auto my-2 rounded w-96">
                @elseif($fotoLama)
                    <img src="{{ asset('storage/' . $fotoLama) }}" alt="" class="h-auto my-2 rounded w-96">
                    <p class="px-2 py-1 my-2 text-sm rounded bg-warning-200 w-96">
                ...
                <div x-data="{ isUploading: false, progress: 0, finish: false }" x-on:livewire-upload-start="isUploading = true"
                    ...
                    <div class="w-full sm:w-96">
                        <input type="file" name="foto" wire:model="foto" id="fotoKegiatan"
            ...
            <div class="mb-4">
                ...
                <div class="px-4 py-4 my-2 bg-white rounded">
                    <p class="text-sm font-medium">Deskripsi Lama</p>
                    <div class="mt-2">
                        {!! $deskripsiLama !!}
                    </div>
                </div>
                ...
                <div wire:ignore class="mt-8">
                    <p class="mb-2 text-sm font-medium">Deskripsi Baru</p>
                    <textarea name="deskripsi" wire:model="deskripsi" id="deskripsi" cols="30" rows="30" required></textarea>
                </div>
            </div>
