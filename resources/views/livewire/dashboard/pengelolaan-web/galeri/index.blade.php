<div>
            ...
            <div class="px-4 py-4 bg-white rounded">
                ...
                <div class="">
                    <form wire:submit.prevent="upload">
                        ...
                        <div x-data="{ isUploading: false, progress: 0, finish: false }"
            ...
            <div
                ...
                <div class="absolute bottom-0 w-full px-4 py-4 bg-opacity-60 bg-slate-950">
                    ...
                    <div class="">
                        ...
                        <button type="button" wire:click="$set('hapusId', {{ $foto->id }})" data-te-toggle="modal"
                            data-te-target="#modalKonfirmasiHapusFoto" data-te-ripple-init data-te-ripple-color="light"
    ...
    <div class="w-full bg-white rounded h-96">
        <div class="flex flex-col items-center justify-center h-full">
            <img src="{{ asset('assets/illustrations/data-not-found.png') }}" alt="" class="w-auto h-48">
