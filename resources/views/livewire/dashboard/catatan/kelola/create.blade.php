<div class="relative p-4">
    ...
    @if ($notification['show'])
        ...
        <div class="flex items-center px-3 py-3 mb-3 bg-success-200">
            <p class="text-sm basis-full text-dark-secondary">Catatan baru dengan nama " <span
    ...
    <div class="relative">
        <div class="relative mb-4">
            <label for="" class="block mb-2 font-medium caption text-dark-secondary">Nama Catatan</label>
            <input type="text" wire:model.defer="namaCatatan"
