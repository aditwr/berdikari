        ...
        <div class="">
            <div class="">
                <div class="flex flex-col w-full overflow-x-auto">
                    <table class="w-full overflow-x-auto text-sm font-normal text-left">
                        <thead class="overflow-hidden rounded">
                            <tr class="flex items-center justify-between text-xs border-b-2 border-neutral-100 lg:px-2">
                                ...
                                <th scope="col" class="w-64 py-3 pl-1">Nama Keuangan</th>
                                <th scope="col" class="w-32 py-3 pl-2">Total Saldo</th>
                                <th scope="col" class="w-32 py-3 pl-2">Tanggal dibuat</th>
                                <th scope="col" class="px-2 py-3">Keterangan</th>
                                @if (auth()->user()->can('edit-kategori-keuangan') ||
                                        auth()->user()->can('hapus-kategori-keuangan'))
                        ...
                        <tbody>
                            @if ($daftarKeuangan)
                                @foreach ($daftarKeuangan as $keuangan)
                                    <tr
                                        ...
                                        <td class="px-2 py-2 whitespace-nowrap">
                                            <div class="space-y-2">
                                                <button type="button" class="text-info-700 btn-secondary-small"
                                                    ...
                                                    data-te-target="#keteranganKeuangan{{ $keuangan->id }}"
                                        ...
                                        <div data-te-modal-init
                                            ...
                                            id="keteranganKeuangan{{ $keuangan->id }}" tabindex="-1"
                                        ...
                                        <td class="w-32 py-2 pl-2 text-sm whitespace-nowrap ">
                                            @can('edit-kategori-keuangan')
                                                <button type="button" wire:click="setEdit({{ $keuangan }})"
                                                    class="text-warning-700 bg-warning-200 btn-secondary-small"
                                                    data-te-toggle="modal" data-te-target="#editKeuanganModal"
                                                    data-te-ripple-init data-te-ripple-color="light">
                                            ...
                                            @can('hapus-kategori-keuangan')
                                                <button type="button" class="bg-danger-200 btn-secondary-small"
                                                    wire:click="$set('deleteId', {{ $keuangan->id }})"
                                                    data-te-toggle="modal"
                                                    data-te-target="#deleteKeuanganModal{{ $keuangan->id }}"
                                                    data-te-ripple-init data-te-ripple-color="light">
                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24"
                                        ...
                                        <div data-te-modal-init wire:ignore
                                            ...
                                            id="deleteKeuanganModal{{ $keuangan->id }}" tabindex="-1"
                                            ...
                                            <div data-te-modal-dialog-ref
                                                ...
                                                <div
                                                    ...
                                                    <div class="relative p-4">
                                                        <p>Apakah anda yakin ingin menghapus keuangan "<span
                                                                class="font-medium">{{ $keuangan->nama }}</span>"?
                                                            Semua data pemasukan dan pengeluaran juga akan terhapus
                                                            secara permanen.
                                                        </p>
                                                    </div>
                                                    <!--Modal footer-->
                    ...
                    <div data-te-modal-init wire:ignore
                        class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
                        id="editKeuanganModal" tabindex="-1" aria-labelledby="exampleModalCenteredScrollable"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="">
                                        ...
                                        <h6 class="text-dark-secondary">untuk keuangan nama keuangan
                                        </h6>
                                    </div>
                                    <!--Close button-->
                                    <button type="button"
                                ...
                                <livewire:dashboard.keuangan.kelola.edit-form />
                            </div>
                        </div>
                    </div>
                </div>
