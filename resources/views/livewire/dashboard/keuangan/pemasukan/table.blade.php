                            ...
                            <table class="w-full overflow-x-auto text-sm font-normal text-left">
                                <thead class="overflow-hidden rounded">
                                    <tr
                                        ...
                                        <th scope="col" class="w-32 py-3 pl-2 bg-blue-100">Tanggal</th>
                                        <th scope="col" class="py-3 pl-2 w-36">Total Kas</th>
                                        <th scope="col" class="px-2 py-3 bg-red-100">Keterangan</th>
                                    ...
                                    @if ($pemasukans->count() > 0)
                                        @foreach ($pemasukans as $pemasukan)
                                            <tr
                                                ...
                                                <td class="w-32 py-2 pl-2 font-normal bg-blue-100 whitespace-nowrap">
                                                ...
                                                <td class="px-2 py-2 bg-red-100 whitespace-nowrap">
                                                    <div class="space-y-2">
